...
- ES6's `map.forEach` is faster than ES5's `Object.keys`, but slower than ES5's and CoffeeScripts `hasOwnProperty` (this should change in the feature, leaving maps as the fastest)
